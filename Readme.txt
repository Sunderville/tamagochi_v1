...
6.Основные параметры жизненного цикла персонажа и анимации доступны для редактирования в виде final-переменных классов Pet и LivingScreenController, соответственно:
...
В планах вынесение данных параметров в единый property-файл для доступа любому пользователю без редактирования исходного кода. На данном этапе стандартный метод привязки данного файла вызывает ошибку парсинга.
